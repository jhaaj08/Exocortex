/* Exocortex PWA Service Worker - Fixed Version */
const CACHE_VERSION = "exocortex-v1.2.0";
...
// Install event - cache core assets with better error handling
self.addEventListener("install", (event) => {
  ...
  event.waitUntil(
    caches.open(STATIC_CACHE).then(async (cache) => {
      ...
      console.log("[SW] Caching results:", results);
      return results;
    }).catch(error => {
